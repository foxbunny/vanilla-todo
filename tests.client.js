{
  ...
  testDocument('index.html')
    .useCase('Default UI', (ui, done) => {
      ui.hasMatchingElements('button', 'Add task')
    ...
    .useCase('Add new task', (ui, done) => {
      ...
      ui.hasMatchingElements('button', 'Clear completed')
      ui.countMatchingElements('form field', 'Task:', 1)
    ...
    .useCase('Add multiple tasks', (ui, done) => {
      ...
      ui.clickElement('button', 'Add task')
      ui.clickElement('button', 'Add task')
      ui.countMatchingElements('form field', 'Task:', 3)
      ui.hasMatchingElements('button', 'Clear completed')
      done()
    })
    .useCase('Remove task', (ui, done) => {
      ui.clickElement('button', 'Add task')
      ui.clickElement('button', 'Add task')
      ui.countMatchingElements('form field', 'Task:', 2)
